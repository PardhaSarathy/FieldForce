        ...
        <(String, List<({IconData icon, String label, String route})>)>[
            ...
            (
              ...
              [
                ...
                (
                  icon: Icons.map_outlined,
                  label: 'Team Map',
                  route: Routes.teamMap,
                ),
                (
                  icon: Icons.flag_outlined,
                  label: 'Assign Targets',
                  route: Routes.targetAssignment,
                ),
                (
                  icon: Icons.payments_outlined,
                  label: 'Travel Rates',
                  route: Routes.rateAssignment,
                ),
                (
                  icon: Icons.insights_outlined,
                  label: 'Team Performance',
                  route: Routes.teamPerformance,
                ),
              ],
            ),
          if (session.isAdmin)
          ...
          (
            ...
            [
              ...
              (icon: Icons.search, label: 'Search', route: Routes.search),
              (
    ...
    return Drawer(
      ...
      child: SafeArea(
        child: Column(
          ...
          children: [
            // The header is the profile. Tapping your own photo is where people
            // look for it, so the row opens My Profile rather than being a
            // decorative block above a menu item that does the same thing.
            InkWell(
                  ...
                  for (final (title, items) in groups) ...[
                    ...
                    for (final item in items)
                      ListTile(
                        ...
                        title: Text(item.label, style: AppTypography.titleSm),
                        onTap: () => go(item.route),
                      ),
                  ],
                ],
              ...
              child: ListTile(
                ...
                onTap: () async {
                  final confirmed = await showConfirmDialog(
                    ...
                    title: 'Sign out?',
                    message:
                        'Any work saved on this device stays safe and '
